...
faq:
  ...
  - question: 'Warum vergesse ich trotz Stehschreibtisch aufzustehen?'
    answer: 'Weil Versunkenheit und Bequemlichkeit stärker sind als Vorsätze. Ohne weichen, sichtbaren Cue bleibt der Tisch unten — bis du es abends bereust. Das ist normal, kein Charakterfehler.'
  - question: 'Warum nerven Stehschreibtisch-Erinnerungen so schnell?'
    answer: 'Weil jede Erinnerung eine Unterbrechung ist. Zu laut, zu oft oder mit Schuldgefühl (Streaks, Sirenen) → Reminder aus. Weniger und weicher hält länger.'
  - question: 'Reicht ein Post-it oder OS-Timer als Sit/Stand-Reminder?'
    answer: 'Ja. Viele brauchen keine App. Ein sichtbarer Cue am Desk oder ein sanfter System-Timer reicht — solange du ihn nicht hasst und Pause machen darfst.'
  - question: 'Soll die Erinnerung piepen oder nur sichtbar sein?'
    answer: 'Erst sichtbar testen (Zweitmonitor, dezentes Fenster). Leiser Ton oder Toast dazu, wenn du den Cue sonst verpasst — getrennt abschaltbar. Die Mischung aus Sichtbarkeit und leichtem Signal triggert oft genug, ohne zu schreien.'
  - question: 'Hilft eine Aufsteh-Erinnerung gegen Rückenschmerzen?'
    answer: 'Kein Versprechen: Nach einer Woche Reminder sind Schmerzen nicht magisch weg. Sinnvoll ist Prävention — Haltung wechseln, bevor Starre sich festsetzt. Bei anhaltenden Beschwerden Fachperson.'
  - question: 'Was meint Micro-Habit beim Sit/Stand-Wechsel?'
    answer: 'Ein kleiner, wiederholbarer Loop: weicher Cue → Tisch hoch oder runter → weiterarbeiten. Kein Workout, keine Belohnungsshow — nur präventive Wiederholung, die über Wochen selbstverständlicher wird.'
  - question: 'Wann lohnt eine lokale Desk-PWA für Erinnerungen?'
    answer: 'Wenn du den Rhythmus dauerhaft sichtbar halten willst, ohne Account und ohne Fitness-Druck — und Settings so leise einstellen kannst, dass der Cue bleibt und die Micro-Habit wachsen kann.'
---
...
Wenn das schon trägt, brauchst du keine weitere Software. Intervall-Ranges und Alltagstakte: wieder [wie oft Sit/Stand wechseln](/blog/sit-stand-wechsel-wie-oft/).
...
Wie du in einer solchen App Sound und Notifications *einstellst* (Help, Schritt für Schritt): [Stehschreibtisch-App — Erinnerung, Sound & Settings](/blog/stehschreibtisch-app-erinnerung-sound-settings/).
