...
faq:
  ...
  - question: 'Reicht Motivation, um öfter am Stehschreibtisch zu stehen?'
    answer: 'Selten dauerhaft. Vorsätze halten den Vormittag, nicht den dritten Call. Umgebung und ein kleiner Loop (Cue → Tisch-Taste → weiterarbeiten) schlagen Willenskraft.'
  - question: 'Warum bleibt der Tisch nach Meetings unten?'
    answer: 'Weil der Call den Rhythmus bricht und niemand ihn danach wieder anstößt. Ohne explizites „danach eine Höhe wechseln“ bleibt die letzte Sitzposition der Default bis Feierabend.'
  - question: 'Soll ich den Stehschreibtisch standardmäßig auf Stehhöhe lassen?'
    answer: 'Als Experiment ja — nicht als Dogma. Ein stehender Start macht Sitzen zur bewussten Handlung. Wenn die Füße protestieren, zurück auf Sitz-Default und kürzere Stehblöcke.'
  - question: 'Was tun, wenn ich den Sit/Stand-Rhythmus wieder verloren habe?'
    answer: 'Wie beim Sport: einmal raus, und der Wiedereinstieg ist schwerer als der nächste Wechsel. Nicht den verpassten Tag nachholen — den nächsten Cue mitnehmen. Ein leises „hey, ich bin noch da“ (sichtbar oder Notification) hilft mehr als ein Neustart-Vorsatz.'
  - question: 'Wie starte ich klein, ohne mich zu überfordern?'
    answer: 'Eine Woche: kurze Stehphasen, nicht Maximal-Stehen. Eine sichtbare Erinnerung am Desk, Pause bei Calls erlaubt. Intervalle erst justieren, wenn der Loop überhaupt stattfindet.'
  - question: 'Brauche ich eine App, damit der Home-Office-Rhythmus hält?'
    answer: 'Nein. Sticky, Task-Grenze oder OS-Timer reichen. Eine ruhige Desk-App hilft nur, wenn du den Takt dauerhaft neben der Arbeit sichtbar halten willst — ohne Streaks und ohne Cloud.'
  - question: 'Ist das Problem ein fehlender Pomodoro-Timer?'
    answer: 'Meist nicht. Pomodoro taktet Arbeit; Sit/Stand taktet Haltung. Ein Fokus-Timer hebt den Tisch nicht. Details: Artikel „Stehschreibtisch-Rhythmus ohne Pomodoro“.'
---
...
Das ist keine Charakterfrage. Es ist **Kauf ≠ Nutzung**. Der Stehschreibtisch löst das Problem nicht allein — [stundenlang dieselbe Haltung](/blog/sit-stand-ohne-pomodoro/) schon.
...
Was hier *nicht* die erste Schraube ist: die genaue Minuten-Zahl. Die kommt später — [wie oft wechseln](/blog/sit-stand-wechsel-wie-oft/). Zuerst muss der Tisch **überhaupt wieder fahren**.
...
1. Nimm den ungenutzten Tisch als Umweltproblem, nicht als Disziplin-Defizit.  
2. Lege Default-Höhe und eine Call-Nachregel fest.  
3. Cue ins Sichtfeld der Arbeit, Reibung zur Taste gegen null.  
4. Eine Woche klein starten; Minuten erst danach.  
5. Skippen ist normal — den nächsten leisen Cue mitnehmen, nicht den Tag nachholen.
